...
![Training error (left) and test error (right) on CIFAR-10 with 20-layer and 56-layer “plain” networks. The deeper network has higher training error, and thus test error. Similar phenomena on ImageNet is presented in Fig. 4.](page_1012_370_496_246.png)
...
\footnotetext{2This hypothesis, however, is still an open question. See [28].}
...
<table>
  ...
  <tr>
    <td>conv1</td>
    <td>112×112</td>
    <td colspan="6">3×3 max pool, stride 2</td>
  </tr>
  <tr>
    <td>conv2_x</td>
    <td>56×56</td>
...
![Training curves for plain and residual networks on ImageNet](page_101_624_495_312.png)
